...
public class ItemTravelBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.wizag.taxi.common.models.Travel mItem;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.wizag.taxi.common.models.Travel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.wizag.taxi.common.models.Travel Item) {
    ...
    @Nullable
    public com.wizag.taxi.common.models.Travel getItem() {
        return mItem;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItem((com.wizag.taxi.common.models.Travel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItem(com.wizag.taxi.common.models.Travel Item, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.wizag.taxi.common.models.Travel item = mItem;
        float floatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceRealFloat1000f = 0f;
        java.lang.String textCostAndroidStringUnitMoneyItemCost = null;
        float floatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceReal = 0f;
        int androidDatabindingViewDataBindingSafeUnboxItemDistanceReal = 0;
        java.lang.String titleIdAndroidStringTravelNumberTitleItemId = null;
        ...
        java.lang.String textDistanceAndroidStringUnitDistanceFloatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceRealFloat1000f = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                // read android.databinding.ViewDataBinding.safeUnbox(item.distanceReal)
                androidDatabindingViewDataBindingSafeUnboxItemDistanceReal = android.databinding.ViewDataBinding.safeUnbox(itemDistanceReal);
                ...
                titleIdAndroidStringTravelNumberTitleItemId = titleId.getResources().getString(R.string.travel_number_title, itemId);
                // read @android:string/travel_number_title
                mboundView1AndroidStringTravelNumberTitleItemId = mboundView1.getResources().getString(R.string.travel_number_title, itemId);


                // read (float) android.databinding.ViewDataBinding.safeUnbox(item.distanceReal)
                floatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceReal = ((float) (androidDatabindingViewDataBindingSafeUnboxItemDistanceReal));


                // read ((float) android.databinding.ViewDataBinding.safeUnbox(item.distanceReal)) / (1000f)
                floatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceRealFloat1000f = (floatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceReal) / (1000f);


                // read @android:string/unit_distance
                textDistanceAndroidStringUnitDistanceFloatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceRealFloat1000f = textDistance.getResources().getString(R.string.unit_distance, floatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceRealFloat1000f);
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            // api target 1

            com.wizag.taxi.common.utils.DataBinder.setImageUrl(this.imageMap, itemImageUrl);
            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView1, mboundView1AndroidStringTravelNumberTitleItemId);
            android.databinding.adapters.TextViewBindingAdapter.setText(this.textCost, textCostAndroidStringUnitMoneyItemCost);
            android.databinding.adapters.TextViewBindingAdapter.setText(this.textDistance, textDistanceAndroidStringUnitDistanceFloatAndroidDatabindingViewDataBindingSafeUnboxItemDistanceRealFloat1000f);
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.titleId, titleIdAndroidStringTravelNumberTitleItemId);
    ...
    public static ItemTravelBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemTravelBinding>inflate(inflater, com.wizag.taxi.common.R.layout.item_travel, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemTravelBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.wizag.taxi.common.R.layout.item_travel, null, false), bindingComponent);
    }
    @NonNull
