...
public class ItemServiceBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.wizag.taxi.common.models.Service mItem;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.wizag.taxi.common.models.Service) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.wizag.taxi.common.models.Service Item) {
        this.mItem = Item;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    @Nullable
    public com.wizag.taxi.common.models.Service getItem() {
        return mItem;
    }
    ...
    protected void executeBindings() {
        ...
        com.wizag.taxi.common.models.Service item = mItem;
    ...
    public static ItemServiceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemServiceBinding>inflate(inflater, com.wizag.taxi.rider.R.layout.item_service, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemServiceBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.wizag.taxi.rider.R.layout.item_service, null, false), bindingComponent);
    }
    @NonNull
