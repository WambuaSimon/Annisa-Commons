...
public class CardDriverAcceptedBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.wizag.taxi.common.models.DriverInfo mInfo;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.info == variableId) {
            setInfo((com.wizag.taxi.common.models.DriverInfo) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setInfo(@Nullable com.wizag.taxi.common.models.DriverInfo Info) {
        this.mInfo = Info;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
    ...
    @Nullable
    public com.wizag.taxi.common.models.DriverInfo getInfo() {
        return mInfo;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeInfoDriver((com.wizag.taxi.common.models.Driver) object, fieldId);
        }
        return false;
    }
    private boolean onChangeInfoDriver(com.wizag.taxi.common.models.Driver InfoDriver, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.wizag.taxi.common.models.Car infoDriverCar = null;
        java.lang.String stringValueOfAndroidDatabindingViewDataBindingSafeUnboxInfoDriverRating = null;
        boolean androidDatabindingViewDataBindingSafeUnboxInfoDriverRatingInt0 = false;
        int androidDatabindingViewDataBindingSafeUnboxInfoDriverRating = 0;
        com.wizag.taxi.common.models.Driver infoDriver = null;
        ...
        com.wizag.taxi.common.models.DriverInfo info = mInfo;
        ...
        java.lang.String androidDatabindingViewDataBindingSafeUnboxInfoDriverRatingInt0StringValueOfAndroidDatabindingViewDataBindingSafeUnboxInfoDriverRatingJavaLangString = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
                ...
                // read android.databinding.ViewDataBinding.safeUnbox(info.driver.rating)
                androidDatabindingViewDataBindingSafeUnboxInfoDriverRating = android.databinding.ViewDataBinding.safeUnbox(infoDriverRating);
                ...
                // read android.databinding.ViewDataBinding.safeUnbox(info.driver.rating) != 0
                androidDatabindingViewDataBindingSafeUnboxInfoDriverRatingInt0 = (androidDatabindingViewDataBindingSafeUnboxInfoDriverRating) != (0);
            if((dirtyFlags & 0x7L) != 0) {
                if(androidDatabindingViewDataBindingSafeUnboxInfoDriverRatingInt0) {
                        dirtyFlags |= 0x10L;
                }
                else {
                        dirtyFlags |= 0x8L;
        ...
        if ((dirtyFlags & 0x10L) != 0) {
                ...
                // read String.valueOf(android.databinding.ViewDataBinding.safeUnbox(info.driver.rating))
                stringValueOfAndroidDatabindingViewDataBindingSafeUnboxInfoDriverRating = java.lang.String.valueOf(androidDatabindingViewDataBindingSafeUnboxInfoDriverRating);
        }

        if ((dirtyFlags & 0x7L) != 0) {

                // read android.databinding.ViewDataBinding.safeUnbox(info.driver.rating) != 0 ? String.valueOf(android.databinding.ViewDataBinding.safeUnbox(info.driver.rating)) : "-"
                androidDatabindingViewDataBindingSafeUnboxInfoDriverRatingInt0StringValueOfAndroidDatabindingViewDataBindingSafeUnboxInfoDriverRatingJavaLangString = ((androidDatabindingViewDataBindingSafeUnboxInfoDriverRatingInt0) ? (stringValueOfAndroidDatabindingViewDataBindingSafeUnboxInfoDriverRating) : ("-"));
        }
        // batch finished
        if ((dirtyFlags & 0x7L) != 0) {
            // api target 1
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.textRating, androidDatabindingViewDataBindingSafeUnboxInfoDriverRatingInt0StringValueOfAndroidDatabindingViewDataBindingSafeUnboxInfoDriverRatingJavaLangString);
        }
        if ((dirtyFlags & 0x6L) != 0) {
            // api target 1
    ...
    public static CardDriverAcceptedBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<CardDriverAcceptedBinding>inflate(inflater, com.wizag.taxi.rider.R.layout.card_driver_accepted, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static CardDriverAcceptedBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.wizag.taxi.rider.R.layout.card_driver_accepted, null, false), bindingComponent);
    }
    @NonNull
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): info
        flag 2 (0x3L): null
        flag 3 (0x4L): android.databinding.ViewDataBinding.safeUnbox(info.driver.rating) != 0 ? String.valueOf(android.databinding.ViewDataBinding.safeUnbox(info.driver.rating)) : "-"
        flag 4 (0x5L): android.databinding.ViewDataBinding.safeUnbox(info.driver.rating) != 0 ? String.valueOf(android.databinding.ViewDataBinding.safeUnbox(info.driver.rating)) : "-"
    flag mapping end*/
    //end
}