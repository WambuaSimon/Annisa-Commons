...
public class ActivityEditProfileBinding extends android.databinding.ViewDataBinding  {
    ...
    @Nullable
    private com.wizag.taxi.common.models.Rider mUser;
    // values
    // listeners
    ...
    private android.databinding.InverseBindingListener mboundView3androidTextAttrChanged = new android.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // user
            com.wizag.taxi.common.models.Rider user = mUser;
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.converter == variableId) {
            ...
            setUser((com.wizag.taxi.common.models.Rider) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUser(@Nullable com.wizag.taxi.common.models.Rider User) {
    ...
    @Nullable
    public com.wizag.taxi.common.models.Rider getUser() {
        return mUser;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeUser((com.wizag.taxi.common.models.Rider) object, fieldId);
        }
        return false;
    }
    private boolean onChangeUser(com.wizag.taxi.common.models.Rider User, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    public static ActivityEditProfileBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityEditProfileBinding>inflate(inflater, com.wizag.taxi.rider.R.layout.activity_edit_profile, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityEditProfileBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.wizag.taxi.rider.R.layout.activity_edit_profile, null, false), bindingComponent);
    }
    @NonNull
