package com.wizag.taxi.rider.activities.travel.adapters;
...
import com.wizag.taxi.rider.activities.travel.fragments.TabDriverInfoFragment;
import com.wizag.taxi.rider.activities.travel.fragments.TabReviewFragment;
...
public class TravelTabsViewPagerAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        switch (position) {
            ...
            case (1):
                return TabStatisticsFragment.newInstance(travel);
            case (2):
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            case (0):
                return context.getString(com.wizag.taxi.common.R.string.tab_driver_info);
            case (1):
                return context.getString(com.wizag.taxi.common.R.string.tab_statistics);
            case (2):
                return context.getString(com.wizag.taxi.common.R.string.tab_review);
            default:
                return context.getString(com.wizag.taxi.common.R.string.tab_driver_info);
        }
    }
